...
<div class="flex justify-center items-center h-screen p-6">
  <form class="mt-20 w-80" action="actions/login.php" method="POST">
    <div class="mb-6">
    ...
    <div class="flex flex-col gap-2 md:flex-row">
      <button class="text-white bg-blue-500 hover:bg-blue-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Log in</button>
      <a href="signup.php" class="text-blue-500 hover:text-blue-600 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Sign up</a>
    </div>
  </form>
</div>
